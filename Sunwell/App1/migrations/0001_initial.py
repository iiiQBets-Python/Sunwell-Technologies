# Generated by Django 5.0.8 on 2024-10-23 12:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alert_email_address_1', models.EmailField(max_length=254, null=True)),
                ('alert_email_address_2', models.EmailField(max_length=254, null=True)),
                ('alert_email_address_3', models.EmailField(max_length=254, null=True)),
                ('alert_email_address_4', models.EmailField(max_length=254, null=True)),
                ('alert_email_address_5', models.EmailField(max_length=254, null=True)),
                ('alert_email_address_6', models.EmailField(max_length=254, null=True)),
                ('alert_email_address_7', models.EmailField(max_length=254, null=True)),
                ('alert_email_address_8', models.EmailField(max_length=254, null=True)),
                ('alert_email_address_9', models.EmailField(max_length=254, null=True)),
                ('alert_email_address_10', models.EmailField(max_length=254, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Equipment',
